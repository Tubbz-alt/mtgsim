...
import mtgsim.cards.ChaliceOfTheVoid;
...
public class EldraziStompyWithChaliceOfTheVoid extends Deck {
	
	{
		setName("Eldrazi Stompy with Chalice of the Void");
	}

	public EldraziStompyWithChaliceOfTheVoid() {
		...
		this.addMany(new ChaliceOfTheVoid(), 4);
